...
3.2.0. This is the first stable release for the 3.2 branch. Going forward 3.1
will only receive security updates. 3.2 is a backwards compatible release with
3.1 and 3.0 and provides new features and performance improvements.
...
new library is a fork of Carbon with no additional dependencies. It also offers
...
Development on 3.3 will now start. The `Roadmap
